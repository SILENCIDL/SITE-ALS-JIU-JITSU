    ...
    <section className="relative min-h-screen flex items-center overflow-hidden bg-[#0e1012]">
      ...
      <div className="hidden lg:flex absolute right-0 top-0 bottom-0 w-2/5 items-center justify-center">
        <div className="relative w-full h-full">
          <div className="absolute inset-0 bg-gradient-to-l from-[#0e1012] via-[#0e1012]/20 to-transparent z-10" />
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="relative w-80 h-80">
              <div className="absolute inset-0 border-2 border-[#F33535]/20 rounded-full animate-spin" style={{ animationDuration: "20s" }} />
              <div className="absolute inset-8 border border-[#0C3C78]/30 rounded-full animate-spin" style={{ animationDuration: "15s", animationDirection: "reverse" }} />
              <div className="absolute inset-16 border border-white/5 rounded-full" />
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-32 h-32 bg-[#F33535]/10 rounded-full flex items-center justify-center border border-[#F33535]/20">
                  <span className="text-5xl font-black text-white/80">ALS</span>
                </div>
              </div>
            </div>
          </div>
